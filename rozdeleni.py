...
def load_data(file_name):
    # Načtení dat z CSV souboru s explicitním specifikováním oddělovače středníkem a použitím prvního sloupce jako indexu
...
def main():
    file_name = '/Users/hanazahourova/Desktop/spotřeba.csv'  
    data = load_data(file_name)
    compute_statistics(data)
    determine_distribution(data)
